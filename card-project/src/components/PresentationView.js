      ...
      return (
        <div>
          <div>
            ...
            <div style={hide}>
              {dcheck[this.props.match.params.id][0] === false
                ? (dcolor = "red")
                : (dcolor = "blue")}
              ;
              {dcheck[this.props.match.params.id][0] === false
            ...
            <div style={noteSt}>
              ...
              <h4>
                Complete Status:{" "}
                <span style={{ color: dcolor }}> {dcomplete} </span>{" "}
              </h4>
              <input
                name="checkedB"
                type="checkbox"
                ...
                onChange={() =>
                  this.handleInputChange(
                    this.props.notes[this.props.match.params.id].check[0],
          ...
          >
            ...
            <ModalFooter>
              <Link
                to={`/`}
                onClick={() =>
                  this.handleDelete(this.props.notes[this.props.id]._id)
                }
              >
                <Button
                  color="primary"
